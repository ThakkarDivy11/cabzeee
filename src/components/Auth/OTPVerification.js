        ...
        <div>
          ...
          <div className="mt-1">
            <input
              ...
              maxLength="6"
              {...register('otp')}
              className={`appearance-none block w-full px-3 py-2 border rounded-md placeholder-gray-400 focus:outline-none focus:ring-black focus:border-black sm:text-sm text-center text-lg tracking-widest ${
