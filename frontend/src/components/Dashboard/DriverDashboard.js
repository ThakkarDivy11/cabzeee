...
const DriverDashboard = () => {
  ...
  const toggleAvailability = async () => {
    ...
    console.log(user);
    if (user.documents.insurance.verified && user.documents.license.verified && user.documents.registration.verified) {
      setDriverStatus(newStatus);
    } else {
      toast.error(
        "You are Not Verified! Please Complete Document Verification First"
      );
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage rides, track earnings, and grow your business
            </p>
          </div>
                ...
                <div className="flex items-center">
                  <div
                    className={`w-3 h-3 rounded-full mr-3 ${
                      driverStatus === "online" ? "bg-green-400" : "bg-gray-400"
                    }`}
                  ></div>
